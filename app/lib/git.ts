...
export async function downloadFile(name: string): Promise<string> {
    return (await axios.get(`https://raw.githubusercontent.com/${repo.owner}/${repo.repo}/${sha}/${name}`)).data;
}
